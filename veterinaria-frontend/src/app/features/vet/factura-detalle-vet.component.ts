...
@Component({
  selector: 'app-factura-detalle-vet',
  standalone: true,
  imports: [
    CommonModule,
    MatToolbarModule,
    ...
    <div class="factura-container">
      ...
      <div class="content">
        ...
        <div *ngIf="!cargando && factura" class="factura-detalle">
          ...
          <mat-card class="info-card">
            <mat-card-header>
              <mat-card-title>Información del Dueño</mat-card-title>
            </mat-card-header>
            <mat-card-content>
              <div class="info-grid">
                <div class="info-item">
                  <label>Nombre:</label>
                  <p>{{ factura.dueno_nombre }}</p>
                </div>
                <div class="info-item">
                  <label>Email:</label>
                  <p>{{ factura.dueno_email }}</p>
                </div>
                <div class="info-item">
                  <label>Teléfono:</label>
                  <p>{{ factura.dueno_tel }}</p>
                </div>
              </div>
            </mat-card-content>
          </mat-card>
...
export class FacturaDetalleVetComponent implements OnInit {
  ...
  cargarFactura() {
    ...
    if (!id) {
      this.router.navigate(['/facturas-vet']);
      return;
    }
